 ...
 * 创建时间：  2021年 02月 10日 17时 35分
 */
public class DataCleanManagerUtils {

    private final static String TAG = "com.yangf.pub_libs.util.DataCleanManagerUtils";
    ...
    public static void clearAllCache(Context context) {
        Log4j.d(TAG,context.getCacheDir().getPath());
        deleteDir(context.getCacheDir());
        if (Environment.getExternalStorageState().equals(
                Environment.MEDIA_MOUNTED)) {
            Log4j.d(TAG, Objects.requireNonNull(context.getExternalCacheDir()).getPath());
